...
// Backfill (staff): (re)gera e reenvia a carteira CERTA (OAB p/ Advogado; carteira funcional/porte
// p/ Juiz/Desembargador/Promotor/Procurador) na DM de TODOS os detentores atuais desses cargos.
...
// Exposta como rodarBackfill pra ser chamada tanto pelo slash /gerar-carteirinhas quanto pelo
// botão "🪪 Gerar carteiras" do hub de staff (painel).
async function rodarBackfill(interaction) {
