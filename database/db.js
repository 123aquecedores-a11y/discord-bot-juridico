...
const TABELAS = ['processos', 'medidas', 'mandados', 'oficios', 'rh', 'apelacoes', 'peticoes', 'identidades', 'fichas', 'consultas', 'estado', 'certidoes', 'atosMp', 'documentosAnexados', 'dossiesInquerito', 'instituicoes', 'andamentos', 'solicitacoesCargo'];
