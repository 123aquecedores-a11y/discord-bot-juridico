...
// 'logRh' entrou em 21/08/2026 com o poder administrativo de Desembargador/Procurador: as três
// ações que mudam quem pode o quê (contratar, demitir, licença) passaram a ser gravadas com motivo.
const TABELAS = ['processos', 'medidas', 'mandados', 'oficios', 'rh', 'apelacoes', 'peticoes', 'fichas', 'consultas', 'estado', 'certidoes', 'atosMp', 'documentosAnexados', 'dossiesInquerito', 'instituicoes', 'andamentos', 'solicitacoesCargo', 'preferencias', 'editais', 'inscricoesEdital', 'pecas', 'configGuild', 'logRh'];
